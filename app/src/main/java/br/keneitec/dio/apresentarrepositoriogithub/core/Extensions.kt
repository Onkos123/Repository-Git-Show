package br.keneitec.dio.apresentarrepositoriogithub.core
...
fun Context.createProgressDialog(): AlertDialog {
    return createDialog {
        val padding = this@createProgressDialog.resources.getDimensionPixelOffset(androidx.appcompat.R.dimen.abc_dialog_padding_material)
